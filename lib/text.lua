...
function write_text(monitor,text,x,y,text_color)
    monitor.mon.setCursorPos(x,y)
    monitor.mon.setTextColor(text_color)
    monitor.mon.write(text)
end

function draw_button(monitor,text,x,y,text_color,button_color)
    monitor.mon.setBackgroundColor(button_color)
    write_text(monitor,text,x,y,text_color)
    monitor.mon.setBackgroundColor(default_bg_color)
end

function clear(mon)
  term.clear()
  term.setCursorPos(1,1)
  monitor.mon.setBackgroundColor(colors.black)
  monitor.mon.clear()
  monitor.mon.setCursorPos(1,1)
end